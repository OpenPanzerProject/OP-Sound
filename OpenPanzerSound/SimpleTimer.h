/* OPS_SimpleTimer.h Open Panzer Simple Timer library - for handling timed events without using delays
...
#ifndef OPS_SimpleTimer_H
#define OPS_SimpleTimer_H

#include <Arduino.h>

#define MAX_SIMPLETIMER_SLOTS       10                      // Set this number higher than the maximum number of simultaneous simple timer objects you may create

typedef void (*timer_callback)(void);

class OPS_SimpleTimer {
