/* OPS_SimpleTimer.cpp   Open Panzer Simple Timer library - for handling timed events without using delays
 ...
 * 
 * The library has also been re-named to OPS_SimpleTimer to avoid conflicts with other libraries. 
 *
...
OPS_SimpleTimer::OPS_SimpleTimer() {
...
int OPS_SimpleTimer::findFirstFreeSlot() {
    int i;
...
int OPS_SimpleTimer::setTimer(long d, timer_callback f, int n) {
    int returnID;
    int freeTimer;
...
int OPS_SimpleTimer::setInterval(long d, timer_callback f) {
    return setTimer(d, f, RUN_FOREVER);
}


int OPS_SimpleTimer::setTimeout(long d, timer_callback f) {
    return setTimer(d, f, RUN_ONCE);
}


void OPS_SimpleTimer::deleteTimer(int ID) 
{
    int timerNum;
...
void OPS_SimpleTimer::restartTimer(int ID) 
{
...
boolean OPS_SimpleTimer::isEnabled(int ID) 
{
    int timerNum;
...
void OPS_SimpleTimer::enable(int ID) 
{
    int timerNum;
...
void OPS_SimpleTimer::disable(int ID) 
{
    int timerNum;
...
void OPS_SimpleTimer::toggle(int ID) 
{
    int timerNum;
...
int OPS_SimpleTimer::getNumTimers() {
    return numTimers;
}


int OPS_SimpleTimer::getTimerNum(int ID)
{
    int timerNum = -1;
